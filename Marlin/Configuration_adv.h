...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  59.2        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  25.6        // (Hz) The default dominant resonant frequency on the Y axis.
...
#define CALIBRATION_GCODE
  ...
  #define CALIBRATION_OBJECT_CENTER     { 150, 106,  0 }        // mm
