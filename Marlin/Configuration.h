...
#define STRING_CONFIG_H_AUTHOR "(FrED P5, Logan Greene)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FrED Factory 005"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "FrED_P_005"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND   // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  20.571,  20.571 }
    #define DEFAULT_Ki_LIST { 0.851,   0.851 }
    #define DEFAULT_Kd_LIST { 124.19, 124.19 }
  #else
    // Original Prusa i3 MK3/S
    #define DEFAULT_Kp  20.571
    #define DEFAULT_Ki   0.851
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Original Prusa i3 MK3/S
  #define DEFAULT_bedKp 51.195
  #define DEFAULT_bedKi 0.739
  #define DEFAULT_bedKd 886.947
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -1.715 }
